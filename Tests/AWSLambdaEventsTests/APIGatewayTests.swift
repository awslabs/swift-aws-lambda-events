...
struct APIGatewayTests {
    static let exampleGetEventBody = """
        ...
        """
    // This event is here to preserve backwards compatibility for events without the `domainName` field, see [discussion in #24](https://github.com/awslabs/swift-aws-lambda-events/pull/24#discussion_r969038350).
